...
import formule5 from "@/assets/img/formule-prestige.avif";
...
// Préchargement de la plus grande image pour optimiser le LCP
...
const partners = ref([
  {
    ...
    price: "400 €",
    description: `• Parrainage d’une épreuve préparatoire
  ...
  },
  {
    ...
    price: "750 €",
    description: `• Parrainage d’une épreuve amateur 2
  ...
  },
  {
    ...
    price: "2 500 €",
    description: `• Parrainage d’une épreuve Pro 3
  ...
  },
  {
    ...
    price: "6 000 €",
    description: `• Parrainage d’une épreuve Pro 2
    • Panneau au bord de la piste principale
  ...
  },
  {
    ...
    price: "SUR DEVIS",
    description: `• Accès à l’espace partenaire
...
// Ajout dynamique du préchargement de l’image LCP
onMounted(() => {
